...
class Player {//Объясню название класса-я планировал сделать режим игры Игрок vs PC. Думал создавать объект игрока или компьютера,
    ...
    public void update(char[][] gridOfGame) {
        ...
        if (moveCounter%2==0){
            System.out.println("\tХод №"+ moveCounter+". Нолики, ваша очередь! Введите координаты хода (пример:a2, b1, c3): ");} else {
        ...
        switch (coordinateX){
            ...
            case 'b':x=1;break;
            case 'c':x=2;break;
            default:System.out.println("Вы ввели не верный формат хода. Попробуйте снова (пример:a2, b1, c3)\n");
        ...
        switch (coordinateY){
            ...
            case '2':y=1;break;
            case '3':y=2;break;
            default:System.out.printf("Вы ввели не верный формат хода. Попробуйте снова (пример:a2, b1, c3)\n");
                return;
        }
